# import libraries for Credit Card Fraud Detection:
...
credit_card_data = pd.read_csv('CSV file path')

# let's see first 10 rows of the dataset:
...
sns.relplot(x='Amount', y='Class', hue='Class', data=credit_card_data)
plt.title("Relationship between Amount and Class")
plt.xlabel("Amount")
plt.ylabel("Class")
plt.show()
